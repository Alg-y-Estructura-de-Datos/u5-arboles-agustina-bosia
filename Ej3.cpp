...
int main() {
    ...
    int array[7]={500, 250, 750, 100, 300, 600, 800};
    ...
    try {
        int libro = arbol.search(750);
        int libro1 = arbol.search(300);
        cout << "Los socios "<<libro<<" y "<<libro1<<" siguen activos." <<endl;
    } catch (int e) {
        if (e == 404) {
            cout << "Los socios no están activos" << endl;
        }
    }
